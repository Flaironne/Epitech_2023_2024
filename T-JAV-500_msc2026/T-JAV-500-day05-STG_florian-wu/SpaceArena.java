    ...
    public boolean fight() {
        ...
        while (!this.monsters.isEmpty() && !this.spaceMarines.isEmpty()) {
            ...
            while (spaceMarines.get(0).getHp() > 0 && monsters.get(0).getHp() > 0) {
                ...
                if (!spaceMarines.get(0).getInRangeBool()) {
                        spaceMarines.get(0).moveCloseTo(monsters.get(0));
                    }
                ...
                else if (!monsters.get(0).getInRangeBool()) {
                        monsters.get(0).moveCloseTo(spaceMarines.get(0));
                    }
            }
